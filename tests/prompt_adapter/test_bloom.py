...
PA_PATH = 'stevhliu/bloomz-560m_PROMPT_TUNING_CAUSAL_LM'  ## tweet prompt tuning into complaint/no complaint ( https://huggingface.co/spaces/PEFT/causal-language-modeling/blob/main/prompt_tuning_clm.ipynb )
...
def do_sample(llm, pa_name: str, pa_id: int):
    ...
    sampling_params = vllm.SamplingParams(temperature=0.0, max_tokens=3)
